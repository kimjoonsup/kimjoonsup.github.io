...
<div class="project-grid">
  <article class="project-card">
    ...
    <a class="project-image" href="{{ "/projects/kakao-ai-agent/" | relative_url }}" aria-label="Read about the Kakao AI Agent Competition project">
      <img src="{{ "/assets/images/projects/AutoReply.drawio.png" | relative_url }}" alt="AutoReply agent pipeline diagram">
    </a>
    <p>AutoReply Agent · 2nd Place</p>
  </article>
